...
**Extracted:** 2025-09-21T12:02:32.760880
**Quality Score:** 0.750
...
### [Derivation Techniques and Algorithm](https://mosdac.gov.in/insat-3d-cloud-properties)
...
### [Limitations](https://mosdac.gov.in/insat-3d-cloud-properties)
  * Refer Paper


### [Known problems with data](https://mosdac.gov.in/insat-3d-cloud-properties)
  * Data will be available with delay


### [File Naming Convention](https://mosdac.gov.in/insat-3d-cloud-properties)
  * Following file naming convention are followed:
  * NetCDF File Name (NetCDFFileName): 3DIMG_DDMMMYYYY_HHMM_L2B_CP_IND_V04.0.nc
  ...
  * SatId (2 Char) = 3D
  * SensorId ( 3 Char)= IMG (IMAGER sensor)
...
### [MetaData](https://mosdac.gov.in/insat-3d-cloud-properties)
...
4 | Data Lineage or Quality |  Depends on INSAT-3D products, some times some data gaps may be observed  
5 | Title | Cloud Properties Products from INSAT-3D over Indian Peninsula  
...
13 | Keywords | Cloud Properties, Climate, cloud, cloud remote sensing  
