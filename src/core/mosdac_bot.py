...
class MOSDACBot:
    ...
    def check_components(self):
        ...
        try:
            ...
            from llm_loader import get_llm_info
            info = get_llm_info()
    ...
    def get_data_status(self) -> Dict[str, Any]:
        ...
        status = {
            ...
            "components": {
                "crawler_available": (self.crawl_output_dir.parent.parent.parent / "src/scrapers/crawl4ai_mosdac.py").exists(),
                "ingest_available": (self.crawl_output_dir.parent.parent.parent / "src/ingestion/ingest.py").exists(),
                "chat_available": (self.crawl_output_dir.parent.parent.parent / "src/chat/chat.py").exists(),
